...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialButton signInAnonymouslyButton = findViewById(R.id.sign_in_anonymously_button);
        signInAnonymouslyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
